    ...
    return (
        <div className="min-h-screen bg-white">
            ...
            <div className="container mx-auto px-8 py-16 text-center">
                <h1 className="text-5xl font-semibold text-[#00704A] mb-12">
                    Handcrafted joy to savor<br />and share
                </h1>
                ...
                <div className="grid grid-cols-2 gap-8 max-w-6xl mx-auto">
                    ...
                    <div className="bg-white rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow">
                        <div className="aspect-square bg-gradient-to-br from-red-200 to-red-300 flex items-center justify-center p-8">
                            <img
                        ...
                        <div className="bg-[#8B1538] text-white p-8 text-center">
                            <h3 className="text-2xl font-semibold mb-4">Peppermint Mocha</h3>
                    ...
                    <div className="bg-white rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow">
                        ...
                        <div className="bg-[#8B1538] text-white p-8 text-center">
                            <h3 className="text-2xl font-semibold mb-4">Peppermint Mocha Frappuccino® Blended Beverage</h3>
                            <p className="text-sm mb-6 leading-relaxed">
                    ...
                    <div className="bg-white rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow">
                        ...
                        <div className="bg-[#8B1538] text-white p-8 text-center">
                            <h3 className="text-2xl font-semibold mb-4">Caramel Brulée Latte</h3>
                            <p className="text-sm mb-6 leading-relaxed">
                    ...
                    <div className="bg-white rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow">
                        ...
                        <div className="bg-[#8B1538] text-white p-8 text-center">
                            <h3 className="text-2xl font-semibold mb-4">Chestnut Praline Latte</h3>
                            <p className="text-sm mb-6 leading-relaxed">
                    ...
                    <div className="bg-white rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow">
                        ...
                        <div className="bg-[#8B1538] text-white p-8 text-center">
                            <h3 className="text-2xl font-semibold mb-4">Iced Peppermint Mocha</h3>
                            <p className="text-sm mb-6 leading-relaxed">
                    ...
                    <div className="bg-white rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow">
                        ...
                        <div className="bg-[#8B1538] text-white p-8 text-center">
                            <h3 className="text-2xl font-semibold mb-4">Iced Caramel Brulée Latte</h3>
                            <p className="text-sm mb-6 leading-relaxed">
                    ...
                    <div className="bg-white rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow">
                        ...
                        <div className="bg-[#8B1538] text-white p-8 text-center">
                            <h3 className="text-2xl font-semibold mb-4">Iced Chestnut Praline Latte</h3>
                            <p className="text-sm mb-6 leading-relaxed">
                    ...
                    <div className="bg-white rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow">
                        ...
                        <div className="bg-[#8B1538] text-white p-8 text-center">
                            <h3 className="text-2xl font-semibold mb-4">Sugar Cookie Almondmilk Latte</h3>
                            <p className="text-sm mb-6 leading-relaxed">
            ...
            <div className="container mx-auto px-8 py-4">
                <div className="max-w-6xl mx-auto bg-[#00704A] rounded-lg overflow-hidden shadow-xl flex">
                    {/* Left - Image */}
                    <div className="w-1/2">
                        <img
                            src={sugarCookieLatte}
                    ...
                    <div className="w-1/2 flex flex-col justify-center items-center text-white p-16">
                        ...
                        <p className="text-center mb-8 leading-relaxed text-lg">
                        ...
                        <button 
                            onClick={handleOrderClick}
                            className="border-2 border-white text-white px-8 py-3 rounded-full font-semibold hover:bg-white hover:text-[#00704A] transition-colors"
                        >
                            Order now
                        </button>
                    </div>
            ...
            {/* Sandwich Section */}
            <div className="container mx-auto px-8 py-4 mb-16">
                <div className="grid grid-cols-2 gap-8 max-w-6xl mx-auto">
                    ...
                    <div className="bg-white rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow flex flex-col">
                        ...
                        <div className="bg-[#00704A] text-white p-8 text-center flex-grow flex flex-col justify-between">
                            <div>
                                <h3 className="text-2xl font-semibold mb-4">Bacon, Gouda & Egg Sandwich</h3>
                                <p className="text-sm mb-6 leading-relaxed">
                            ...
                            <div>
                                <button 
                                    onClick={handleOrderClick}
                                    className="border-2 border-white text-white px-6 py-2 rounded-full font-semibold hover:bg-white hover:text-[#00704A] transition-colors"
                                >
                                    Add to order
                                </button>
                            </div>
                    ...
                    <div className="bg-white rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow flex flex-col">
                        ...
                        <div className="bg-[#00704A] text-white p-8 text-center flex-grow flex flex-col justify-between">
                            <div>
                                <h3 className="text-2xl font-semibold mb-4">Crispy Grilled Cheese on Sourdough</h3>
                                <p className="text-sm mb-6 leading-relaxed">
